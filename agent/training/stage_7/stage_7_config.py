"""Command-line configuration for Stage Seven PPO training."""
...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train TensorFlow PPO to prioritize two Stage Seven threats."
    )
    ...
    critic.add_argument("--critic-learning-rate", type=positive_float, default=1.5e-4)
    ...
    critic.add_argument("--critic-max-gradient-norm", type=positive_float, default=1.0)
    ...
    initialization.add_argument(
        "--stage6-checkpoint",
        type=Path,
        help="Expand a Stage Six actor; initialize a fresh Stage Seven critic.",
    )
